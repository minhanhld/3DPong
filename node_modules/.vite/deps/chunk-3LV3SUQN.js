...
function Pi(t2) {
  ...
  const r = s._nextUint32(), o = s._nextUint32(), l2 = s._nextUint32(), f = s._nextUint32(), U = s._nextUint64(), c = s._nextUint64(), h = new Ii(t2, Ti.length + i, 3 * a * 8, true);
  ...
  const y2 = new Ii(t2, l2, f, true);
  for (; y2._offset < f; ) {
    const t3 = y2._nextUint32(), e2 = y2._scan(t3), i2 = Ei(e2), s2 = y2._scan(t3 - e2.byteLength);
...
function Ci() {
  return (Ci = Object.assign || function(t2) {
    for (var e = 1; e < arguments.length; e++) {
      var n2 = arguments[e];
      for (var i in n2)
        Object.prototype.hasOwnProperty.call(n2, i) && (t2[i] = n2[i]);
    }
    return t2;
...
function Mi(t2, e = {}) {
  ...
  if (t2.globalData) {
    const e2 = new ArrayBuffer(20 + 5 * t2.globalData.imageDescs.length * 4), i2 = new DataView(e2);
    i2.setUint16(0, t2.globalData.endpointCount, true), i2.setUint16(2, t2.globalData.selectorCount, true), i2.setUint32(4, t2.globalData.endpointsData.byteLength, true), i2.setUint32(8, t2.globalData.selectorsData.byteLength, true), i2.setUint32(12, t2.globalData.tablesData.byteLength, true), i2.setUint32(16, t2.globalData.extendedData.byteLength, true);
    for (let e3 = 0; e3 < t2.globalData.imageDescs.length; e3++) {
      const n3 = t2.globalData.imageDescs[e3];
    ...
    n2 = Fi([e2, t2.globalData.endpointsData, t2.globalData.selectorsData, t2.globalData.tablesData, t2.globalData.extendedData]);
  }
  const i = [];
  let s = t2.keyValue;
  e.keepWriter || (s = Ci({}, t2.keyValue, { KTXwriter: "KTX-Parse v0.3.1" }));
  for (const t3 in s) {
    const e2 = s[t3], n3 = Vi(t3), a2 = "string" == typeof e2 ? Vi(e2) : e2, r2 = n3.byteLength + 1 + a2.byteLength + 1, o2 = r2 % 4 ? 4 - r2 % 4 : 0;
    i.push(Fi([new Uint32Array([r2]), n3, Oi, a2, Oi, new Uint8Array(o2).fill(0)]));
  }
  const a = Fi(i);
  if (1 !== t2.dataFormatDescriptor.length || 0 !== t2.dataFormatDescriptor[0].descriptorType)
    throw new Error("Only BASICFORMAT Data Format Descriptor output supported.");
  const r = t2.dataFormatDescriptor[0], o = new ArrayBuffer(28 + 16 * r.samples.length), l2 = new DataView(o), f = 24 + 16 * r.samples.length;
  ...
  for (let t3 = 0; t3 < 8; t3++)
    l2.setUint8(20 + t3, r.bytesPlane[t3]);
  for (let t3 = 0; t3 < r.samples.length; t3++) {
    const e2 = r.samples[t3], n3 = 28 + 16 * t3;
    if (e2.channelID)
  ...
  const U = Ti.length + 68 + 3 * t2.levels.length * 8, c = U + o.byteLength;
  let h = n2.byteLength > 0 ? c + a.byteLength : 0;
  h % 8 && (h += 8 - h % 8);
  const _ = [], p2 = new DataView(new ArrayBuffer(3 * t2.levels.length * 8));
  let g2 = (h || c + a.byteLength) + n2.byteLength;
  for (let e2 = 0; e2 < t2.levels.length; e2++) {
    const n3 = t2.levels[e2];
  ...
  return x2.setUint32(0, t2.vkFormat, true), x2.setUint32(4, t2.typeSize, true), x2.setUint32(8, t2.pixelWidth, true), x2.setUint32(12, t2.pixelHeight, true), x2.setUint32(16, t2.pixelDepth, true), x2.setUint32(20, t2.layerCount, true), x2.setUint32(24, t2.faceCount, true), x2.setUint32(28, t2.levels.length, true), x2.setUint32(32, t2.supercompressionScheme, true), x2.setUint32(36, U, true), x2.setUint32(40, o.byteLength, true), x2.setUint32(44, c, true), x2.setUint32(48, a.byteLength, true), x2.setBigUint64(52, BigInt(n2.byteLength > 0 ? h : 0), true), x2.setBigUint64(60, BigInt(n2.byteLength), true), new Uint8Array(Fi([new Uint8Array(Ti).buffer, y2, p2.buffer, o, a, h > 0 ? new ArrayBuffer(h - (c + a.byteLength)) : new ArrayBuffer(0), n2, ..._]));
}
...
//# sourceMappingURL=chunk-3LV3SUQN.js.map
